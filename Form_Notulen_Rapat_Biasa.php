...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $Jumlah_Pengawas_Hadir = $_POST['Jumlah_Pengawas_Hadir'];
      $Undangan_Hadir= $_POST['Undangan_Hadir'];
      $Acara_Rapat = $_POST['Acara_Rapat'];
      $Keputusan_Rapat = $_POST['Keputusan_Rapat'];

      $query = "INSERT INTO notulensi_rapat_biasa  (No_Urut, Tanggal_Rapat, Tempat_Rapat,Jumalah_Anggota_Hadir, Jumalah_Pengurus_Hadir, Jumlah_Pengawas_Hadir, Undangan_Hadir, Acara_Rapat, Keputusan_Rapat) VALUES ('$No_Urut', '$Tanggal_Rapat', '$Tempat_Rapat', '$Jumlah_Anggota_Hadir', '$Jumlah_Pengurus_Hadir', '$Jumlah_Pengawas_Hadir', '$Undangan_Hadir', '$Acara_Rapat', '$Keputusan_Rapat')";
      ...
      header("Location: Admin_Notulen_Rapat_Biasa.php");
}
?>
...
<head>
      ...
      <title>Form Notulensi Rapat Biasa</title>
</head>

<body>

      <div class="form-notulensi-rapat-biasa">
            <header>
                  <div class="Logo">
            ...
            <nav>
                  <div class="navbar">
                        <a href="Admin_Daftar_Anggota.php">Daftar Anggota</a>
            ...
            <section>
                  ...
                  <div class="input">
                        <form class="formulir" action="Form_Notulen_Rapat_Pengawas.php" method="post">
                              ...
                              <label for="Jumlah Anggota ">Jumlah Anggota Hadir :</label>
                              <input type="number" id="Jumlah Anggota" name="Jumlah_Anggota_Hadir" required><br><br>
                              ...
                              <label for="Jumlah Pengawas ">Jumlah Pengawas Hadir :</label>
                              <input type="number" id="Jumlah Pengawas" name="Jumlah_Pengawas_Hadir" required><br><br>
