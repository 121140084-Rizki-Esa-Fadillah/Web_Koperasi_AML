...
if (isset($_GET['No_Urut'])) {
      ...
      $delete_query = "DELETE FROM notulensi_rapat_pengawas WHERE No_Urut = '$delete_No_Urut'";
...
<body>
      <div class="admin-notulen-rapat-pengawas">
            <header>
                  <div class="Logo">
            ...
            <section>
                  ...
                  <div class="tabel">
                        <h2>Tabel Notulen Rapat Pengawas</h2>
                        <?php
                              include("koneksi.php");
                        ...
                        <div class="tombol-tambah">
                              <a href="Form_Notulen_Rapat_Pengawas.php">
                                    <button>Tambah</button>
                              </a>
                        </div>
                        <div class="hapus">
                              <h2>Hapus Data</h2>
                              <form class="form-delete" action="Admin_Notulen_Rapat_Pengawas.php" method="get">
