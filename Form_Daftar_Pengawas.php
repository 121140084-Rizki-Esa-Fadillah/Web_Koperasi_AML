...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $query = "INSERT INTO daftar_pengawas (No_Pengawas, Nama_Lengkap, Jenis_Kelamin, Tempat_Tanggal_Lahir, Alamat, Jabatan) VALUES ('$No_Pengawas', '$Nama_Lengkap', '$Jenis_Kelamin', '$Tempat_Tanggal_Lahir', '$Alamat', '$Jabatan')";
...
<head>
      ...
      <title>Formulir Daftar Pengawas</title>
</head>

<body>

      <div class="form-daftar-pengawas">
            <header>
                  <div class="Logo">
            ...
            <section>
                  ...
                  <div class="input">
                        <form class="formulir" action="Form_Daftar_Pengawas.php" method="post">
                              <h3>Formulir Daftar Pengawas</h3>
                              <label for="nomor">No Pengawas :</label>
                              <input type="number" id="nomor" name="No_Pengawas" required><br><br>
