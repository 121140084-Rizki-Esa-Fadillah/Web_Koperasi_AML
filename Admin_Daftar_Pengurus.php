...
<?php 
include ("koneksi.php");
if (isset($_GET['No_Pengurus'])) {
      $delete_No_Pengurus = $_GET['No_Pengurus'];
    
      $delete_query = "DELETE FROM daftar_pengurus WHERE No_Pengurus = '$delete_No_Pengurus'";
...
<body>
      <div class="admin-daftar-pengurus">
            <header>
                  <div class="Logo">
            ...
            <section>
                  ...
                  <div class="tabel">
                        ...
                        <div class="tombol-tambah">
                              <a href="Form_Daftar_Pengurus.php">
                                    <button>Tambah</button>
                              </a>
                        </div>
                        <div class="hapus">
                              <h2>Hapus Data</h2>
                              <form class="form-delete" action="Admin_Daftar_Pengurus.php" method="get">
                                    <label for="nim">Pilih No Pengurus yang ingin dihapus :</label>
                                    <input type="number" name="No_Pengurus" required>
