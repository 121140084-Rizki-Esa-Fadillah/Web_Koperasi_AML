...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $query = "INSERT INTO daftar_anggota (No_Anggota, Nama_Lengkap, Jenis_Kelamin, Tempat_Tanggal_Lahir, Alamat, Tanggal_Masuk) VALUES ('$No_Anggota', '$Nama_Lengkap', '$Jenis_Kelamin', '$Tempat_Tanggal_Lahir', '$Alamat', '$Tanggal_Masuk')";
      ...
      header("Location: Admin_Daftar_Anggota.php");
}
?>
...
<head>
      ...
      <title>Formulir Daftar Anggota</title>
</head>

<body>

      <div class="form-daftar-anggota">
            <header>
                  <div class="Logo">
            ...
            <section>
                  ...
                  <div class="input">
                        <form class="formulir" action="Form_Daftar_Anggota.php" method="post">
                              <h3>Formulir Daftar Anggota</h3>
                              <label for="nomor">No Anggota :</label>
                              <input type="number" id="nomor" name="No_Anggota" required><br><br>
