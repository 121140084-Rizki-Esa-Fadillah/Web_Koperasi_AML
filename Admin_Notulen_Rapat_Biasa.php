...
<head>
      ...
      <title>Notulen Rapat Biasa</title>
</head>
...
if (isset($_GET['No_Urut'])) {
      ...
      $delete_query = "DELETE FROM notulensi_rapat_biasa WHERE No_Urut = '$delete_No_Urut'";
...
<body>
      <div class="admin-notulen-rapat-biasa">
            <header>
                  <div class="Logo">
            ...
            <section>
                  <div class="sidebar">
                        <h3>Notulen Rapat</h3>
                        <ul>
                              <li><a href="#">Notulen Biasa</a></li>
                              <li><a href="Admin_Notulen_Rapat_Pengurus.php">Notulen Pengurus</a></li>
                              <li><a href="Admin_Notulen_Rapat_Pengawas.php">Notulen Pengawas</a></li>
                        </ul>
                  </div>
                  <div class="tabel">
                        <h2>Tabel Notulensi Rapat Biasa</h2>
                        <?php
                              include("koneksi.php");
                              $sql = "SELECT * FROM notulensi_rapat_biasa";
                              ...
                              if ($result->num_rows > 0) {
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                          ...
                                          "<tr>
                                                ...
                                                <td>" . $row["Jenis_Rapat"] . "</td>
                                                <td>" . $row["Jumlah_Anggota_Hadir"] . "</td>
                                                <td>" . $row["Jumlah_Pengurus_Hadir"] . "</td>
                                                <td>".  $row["Jumlah_Pengawas_Hadir"] . "</td>
                        ...
                        <div class="tombol-tambah">
                              <a href="Form_Notulen_Rapat_Biasa.php">
                                    <button>Tambah</button>
                              </a>
                        </div>
                        <div class="hapus">
                              <h2>Hapus Data</h2>
                              <form class="form-delete" action="Admin_Notulen_Rapat_Biasa.php" method="get">
