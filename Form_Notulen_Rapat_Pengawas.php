...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $query = "INSERT INTO notulensi_rapat_pengawas (No_Urut, Tanggal_Rapat, Tempat_Rapat, Jumlah_Pengawas_Hadir, Undangan_Hadir, Pimpinan_Rapat, Acara_Rapat, Keputusan_Rapat) VALUES ('$No_Urut', '$Tanggal_Rapat', '$Tempat_Rapat', '$Jumlah_Pengawas_Hadir', '$Undangan_Hadir', '$Pimpinan_Rapat', '$Acara_Rapat', '$Keputusan_Rapat')";
      ...
      header("Location: Admin_Notulen_Rapat_Pengawas.php");
}
?>
...
<head>
      ...
      <title>Form Notulensi Rapat Pengawas</title>
</head>

<body>

      <div class="form-notulensi-rapat-pengawas">
            <header>
                  <div class="Logo">
